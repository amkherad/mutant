...
console.log('CONFIG.buildOutputPath', CONFIG.buildOutputPath);
console.log('CONFIG.intermediateAppPath', CONFIG.intermediateAppPath);

module.exports = function (packagedAppPath) {
  const snapshotScriptPath = path.join(CONFIG.buildOutputPath, 'mutant-app.js')
  const coreModules = new Set(['electron', 'atom', 'shell', 'WNdb', 'lapack', 'remote'])
  const baseDirPath = path.join(CONFIG.intermediateAppPath, 'src')
